...
# Target: 40% long stay (1), 60% short stay (0)
long_stay_label = np.zeros(n, dtype=int)
long_stay_label[:int(0.4 * n)] = 1
...
df.to_csv("hospital_bed_dataset_300.csv", index=False)
print("hospital_bed_dataset_300.csv generated successfully!")
